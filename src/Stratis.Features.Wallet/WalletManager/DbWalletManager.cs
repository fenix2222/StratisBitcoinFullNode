...
{
    /// <summary>
    /// A manager providing operations on wallets, managing data in database.
    /// </summary>
    public class DbWalletManager : BaseWalletManager
    {
        ...
        protected virtual void SaveWalletInternal(IWallet wallet)
        {
            ...
            {
                throw new WalletException($"You can save only wallets of type Wallet in using {nameof(DbWalletManager)}");
            }
        }
